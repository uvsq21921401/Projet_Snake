...
Pour commencer une nouvelle partie après un "Game Over", il suffit de fermer la fenêtre du plateau de jeu et de choisir à nouveau un niveau.

Le joueur peut également consulter les 10 meilleurs scores dans le menu.
